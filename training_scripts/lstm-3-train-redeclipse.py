...
training_file_dir = '../training_data/clean-data/'
n_input = 1 		# sequential input vector numbers for lstm
tensor_size = 20         # length of each input vector
n_classes = 5           # number of classes for the output
input_index = 0
output_index = 1
# Target log path
logs_path = '../training_data/logs-re/'
