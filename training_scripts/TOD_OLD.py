...
class TOD(object):
    def __init__(self,sct):
        ...
        #self.PATH_TO_CKPT 	= '/home/tianyiliu/Documents/workspace/bench-train-games/AI-models/supertuxkart/frozen_inference_graph.pb'
        #self.PATH_TO_LABELS 	= '/home/tianyiliu/Documents/workspace/bench-train-games/AI-models/supertuxkart/label_map13.pbtxt'
        self.PATH_TO_LABELS 	= './AI-models/supertuxkart/label_map13.pbtxt'
        self.NUM_CLASSES 	= 13
        self.category_index 	= self._load_label_map()
        #self.shape 		= [100,670,112,580-20,70,540,70,420,115,416,165-20,461,182-35,505,180-30,585]
        #self.shape             = [120,802,128,723,72,688,76,560,128,540,168,595,166,667,206,732]
        self.shape  		= [118,938,136,775,86,726,83,609,137,570,172,650,175,700,192,779]
        #self.all_stops         = [[120,802],[128,723],[72,688],[76,560],[128,540],[168,595],[166,667],[206,732]]
        self.all_stops 		= [[118,938],[136,775],[86,726],[83,609],[137,570],[172,650],[175,700],[192,779]]
        #self.all_stops         = [[100,670],[112,580-20],[70,540],[70,420],[115,416],[165-20,461],[182-35,505],[180-30,585]]
        self.pixel_error 	= 25
        ...
        self.good_angle 	= 40
        self.last_position	= [118,960]
        self.dst 		= self.all_stops[1]
        self.region 		= {'top': 50, 'left': 64, 'width': 1280, 'height': 960}
        #self.region 		= {'top': 90, 'left': 64, 'width': 1020, 'height': 730}
        self.im_width           = 1280
        self.im_height          = 960
        self.sct 		= sct
