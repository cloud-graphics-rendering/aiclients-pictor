...
def class_text_to_int(row_label):
    if row_label == 'OK':
        return 1
    elif row_label == 'single_player':
        return 2
    elif row_label == 'load_game':
        return 3
    elif row_label == 'load':
        return 4
    elif row_label == 'hunter':
        return 5
    elif row_label == 'farmer':
        return 6
    elif row_label == 'hoplite':
        return 7
    elif row_label == 'militia':
        return 8
        ...
        return 12
    elif row_label == 'stone':
        return 13
    elif row_label == 'knight':
        return 14
    elif row_label == 'enemy_center':
        return 15
    elif row_label == 'no':
        return 16
